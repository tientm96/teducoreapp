...
{
    //Khởi tạo một số dlieu mẫu để làm việc khi khởi tạo db.
    //Chúng ta cấu hình class này trong method ConfigureServices() của class Startup của pr MVC.
    //  tại //Add DbInitializer services    services.AddTransient<DbInitializer>();
    ...
    public class DbInitializer
    {
        ...
        public async Task Seed()
        {
            ...
            //tạo các dl cho bảng AdvertistmentPages
            ...
            //tạo các dl cho bảng ProductCategories.
            //  Add luôn cả Product trong ProductCategories này bằng các thuộc tính của nó.
            ...
            //tạo các dl cho bảng SystemConfigs.
